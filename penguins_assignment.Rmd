...
### Preparing packages and raw data
...
**Question:** Is the relationship between penguin culmen **length** -(response)- and culmen **depth** -(covariate)- significantly different between different **speciess**?
...
2\.
Distribution of residuals is approximately normally distributed.
